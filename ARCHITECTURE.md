...
| 持久化 | 纯文件系统（JSONL session / JSON settings / 文件型 skills & prompts / trust.json / models.json / hooks.json），无数据库 |
...
cli.ts
 ...
 │            no-approve/transport/steering-mode/follow-up-mode/
 ...
 ├─ bootstrap({ ...bootstrapOptions, trusted })
